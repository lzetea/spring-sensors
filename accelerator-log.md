...
```json
{
  ...
  "publisherRepository" : "lzetea.azurecr.io/lzetea/supply-chain",
  "title" : "Tanzu Sensor"
}
```
## Log
...
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.merge.transformations[0].sources[1].<combo>.transformations[1].transformations[1] (RewritePath)
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [Sensor Database->Tanzu Sensor]
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->lzetea.azurecr.io/lz...(truncated)]
...
┃ ┃ ┃ ┗ ┗ ┗ ┗  Info Will replace [spring-sensors->spring-sensors]
